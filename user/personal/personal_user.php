...
elseif ($act=='userprofile_save')
{
	...
	$sttt['fullname']=$setsqlarr['realname'];
	$sttt['sex']=$setsqlarr['sex'];
	$sttt['sex_cn']=$setsqlarr['sex_cn'];
	$sttt['birthdate']=$setsqlarr['birthday'];
	$sttt['marriage']=$setsqlarr['marriage'];
	$sttt['marriage_cn']=$setsqlarr['marriage_cn'];
	$sttt['height']=$setsqlarr['height'];
	$sttt['householdaddress']=$setsqlarr['householdaddress'];
	$db->updatetable(table("resume"),$sttt,array("uid"=>intval($_SESSION['uid'])));
