...
<table id="notice" width="100%" border="0" style="border-top:1px #CCCCCC dotted;background-color: #EEEEEE; line-height: 230%;padding: 15px; margin-top: 10px; ">
    <tbody><tr>
	    <td class="ajax_app_tip" style="padding-left: 10px;">您每天可以申请<span></span>门课程，今天已经申请了<span></span>门，还可以申请<span></span>门
	    </td>
    </tr>
</tbody>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableall" id="app_ok" style="display:none">
    <tr>
		...
		<td>
			...
			<a href="javascript:void(0)"  class="DialogClose underline" style="color:#0180cf;text-decoration:none;">申请完成</a>
			</div>
		</td>
    </tr>
</table>
