...
var m_selector = {
	...
	states: function(e) {
		...
		var c = '<ul id="tag_level">',
			a = new Array("0,全部","1,合适","2,不合适","3,上岗","4,放鸽子");
		if (!d) {
			clog("nodiv");
			return
		}
