...
var nativeShare = function (elementNode, config) {
    ...
    this.share = function (to_app) {
        ...
        if (isucBrowser) {
            ...
            if (typeof(ucweb) != "undefined") {
                ucweb.startRequest("shell.page_share", [title, img_title, url, to_app, "", "@" + from, ""])
            } else {
                if (typeof(ucbrowser) != "undefined") {
                    ucbrowser.web_share(title, img_title, url, to_app, "", "@" + from, '')
                } else {
                }
            }
        } else {
    ...
    this.init = function () {
        ...
        if (isqqBrowser || isucBrowser) {
            ...
            $('.lock_win').hide();
            $('.newsshare').show();
            $('.newsshare').css('height', $(document).height());
            $('.newsshare').click(function(){
                $('.newsshare').hide();
            });
