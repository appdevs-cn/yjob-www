...
if($_COOKIE['QS']['username'] && $_COOKIE['QS']['password']){
	...
	{
			setcookie("QS[uid]",$_SESSION['uid'],time() + 30*24*3600,$QS_cookiepath, $QS_cookiedomain);
			setcookie("QS[username]",$_SESSION['username'],time() + 30*24*3600,$QS_cookiepath, $QS_cookiedomain);
			setcookie("QS[password]",$_SESSION['password'],time() + 30*24*3600,$QS_cookiepath, $QS_cookiedomain);
			setcookie("QS[utype]",$_SESSION['utype'],time() + 30*24*3600,$QS_cookiepath, $QS_cookiedomain);
