<?php
function tpl_function_qishi_hunter_news_list($params, &$smarty)
{
global $db,$_CFG;
...
$aset['showname']=isset($aset['showname'])?$aset['showname']:'QS_hunter_newsshow';
$aset['listpang']=isset($aset['listpang'])?$aset['listpang']:'QS_hunter_newslist';
...
$result = $db->query("SELECT id,subsite_id,title,tit_color,tit_b,is_url,content,Small_img,addtime,click FROM ".table('article')." ".$wheresql.$orderbysql.$limit);
$list= array();
