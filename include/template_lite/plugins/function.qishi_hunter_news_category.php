<?php
function tpl_function_qishi_hunter_news_category($params, &$smarty)
{
global $db,$_CFG;
...
$aset['showname']=isset($aset['showname'])?$aset['showname']:'QS_hunter_newslist';
...
$result = $db->query("SELECT id,categoryname,parentid FROM ".table('article_category')." ".$wheresql." ORDER BY  category_order DESC".$limit);
$list=array();
