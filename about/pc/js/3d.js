window.onload = function(){
	...
	var aSort = [];
	var aPosition = [
					{width:240,height:240,top:0,left:440,zIndex:10},
					{width:180,height:180,top:30,left:230,zIndex:8},
					{width:120,height:120,top:60,left:80,zIndex:6},
					{width:60,height:60,top:90,left:0,zIndex:4},
					{width:60,height:60,top:90,left:1060,zIndex:4},
					{width:120,height:120,top:60,left:920,zIndex:6},
					{width:180,height:180,top:30,left:710,zIndex:8}
		]
	...
	for(i=0;i<aLi.length;i++){
		...
		myAddEvent(aLi[i], 'mouseover', function(){
			var oDiv = this.getElementsByTagName('em')[0];
			startMove(oDiv);
